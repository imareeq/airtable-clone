...
export const BaseFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BaseSelect> = z.object({
...
export const BaseFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    color: z.boolean().optional(),
    ownerId: z.boolean().optional(),
...
export const BaseFindFirstOrThrowSchema: z.ZodType<Prisma.BaseFindFirstOrThrowArgs> = z.object({ select: BaseFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BaseIncludeObjectSchema.optional()), orderBy: z.union([BaseOrderByWithRelationInputObjectSchema, BaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: BaseWhereInputObjectSchema.optional(), cursor: BaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BaseScalarFieldEnumSchema, BaseScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BaseFindFirstOrThrowArgs>;

export const BaseFindFirstOrThrowZodSchema = z.object({ select: BaseFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BaseIncludeObjectSchema.optional()), orderBy: z.union([BaseOrderByWithRelationInputObjectSchema, BaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: BaseWhereInputObjectSchema.optional(), cursor: BaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BaseScalarFieldEnumSchema, BaseScalarFieldEnumSchema.array()]).optional() }).strict();