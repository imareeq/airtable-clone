...
export const ViewFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ViewSelect> = z.object({
...
export const ViewFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    tableId: z.boolean().optional(),
    table: z.boolean().optional(),
...
export const ViewFindFirstOrThrowSchema: z.ZodType<Prisma.ViewFindFirstOrThrowArgs> = z.object({ select: ViewFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ViewIncludeObjectSchema.optional()), orderBy: z.union([ViewOrderByWithRelationInputObjectSchema, ViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: ViewWhereInputObjectSchema.optional(), cursor: ViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ViewScalarFieldEnumSchema, ViewScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ViewFindFirstOrThrowArgs>;

export const ViewFindFirstOrThrowZodSchema = z.object({ select: ViewFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ViewIncludeObjectSchema.optional()), orderBy: z.union([ViewOrderByWithRelationInputObjectSchema, ViewOrderByWithRelationInputObjectSchema.array()]).optional(), where: ViewWhereInputObjectSchema.optional(), cursor: ViewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ViewScalarFieldEnumSchema, ViewScalarFieldEnumSchema.array()]).optional() }).strict();