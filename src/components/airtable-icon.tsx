...
type AirtableIconProps = React.SVGProps<SVGSVGElement> & {
  variant?: "default" | "white";
};

export default function AirtableIcon({
  className,
  variant = "default",
  ...props
}: AirtableIconProps) {
  ...
  return (
    <svg
      ...
      className={cn("h-auto w-10.5 shrink-0", className)}
      {...props}
    >
      <g>
        <path
          fill={white ? "white" : "rgb(255, 186, 5)"}
        ...
        />
        <path
          fill={white ? "white" : "rgb(57, 202, 255)"}
        ...
        />
        <path
          fill={white ? "transparent" : "rgba(0, 0, 0, 0.25)"}
